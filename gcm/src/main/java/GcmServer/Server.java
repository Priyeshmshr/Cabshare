  ...
  public void handleIncomingDataMessage(Map<String, Object> jsonObject) {
    ...
    if(payload.get("my_action").equals("Update Registration ID")){
    	try {
			...
			db.Update(payload.get("registrationId"), payload.get("userId"));
		} catch (IOException e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		} catch (SQLException e) {
		...
		try {
			Map<String,String> list = db.Location(payload.get("startLat"),payload.get("startLon"),payload.get("destLat"),payload.get("destLon"),payload.get("type"),payload.get("user"),from);
